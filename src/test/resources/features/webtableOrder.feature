Feature: Web table user order feature
  ...
  Scenario: User should be able to place order and order seen in web table
    ...
    And  user enters customers name "Sherlock Holmes"
  ...
  Scenario Template: User should be able to place order and order seen in web table
    ...
    Examples: Famous female scientists
      ...
      | Screenable  | 4        |  Lise Meither    | London st | London | England | 50505   | Visa     | 1111222233334444 | 12/24   | Lise Meither       |
    ...
    Examples: Famous male scientists
      ...
      | MoneyCog    | 6        | Arnold Schwarzenegger | London st | London | England | 50505   | Visa     | 1111222233334444 | 12/24   | Arnold Schwarzenegge |
